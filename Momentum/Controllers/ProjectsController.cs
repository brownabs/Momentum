...
namespace Momentum.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        {
           // ViewData["ProjectId"] = new SelectList(_context.Project, "ProjectId");
        ...
        public async Task<IActionResult> Create([Bind("ProjectId,DateCreated,DurationGoal,DateCompleted,ProjectName,Language,SourceCodeLink,PublishedApplicationLink,ImagePath,IsCompleted,UserId")] Project project)
        {
